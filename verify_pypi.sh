#!/usr/bin/env bash
# Verifies that the pajgps-api package was uploaded to PyPI correctly.
#
# What it does:
#   1. Creates a temporary virtual environment (isolated from your project).
#   2. Installs pajgps-api from the real PyPI.
...
pip install "$PACKAGE_NAME==$EXPECTED_VERSION"
...
echo ""
echo "=== All checks passed! Package $PACKAGE_NAME $EXPECTED_VERSION is working correctly from PyPI. ==="
