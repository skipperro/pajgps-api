...
class TestNotifications(unittest.TestCase):
    ...
    def test_get_notifications_success(self, mock_execute):
    ...
    @patch("pajgps_api.pajgps_requests.PajGpsRequests._execute_request")
    def test_get_device_notifications_success(self, mock_execute):
        mock_response = unittest.mock.Mock()
        mock_response.json.return_value = {
            "success": [
                {
        ...
        notifications = self.api.get_device_notifications(101)
    ...
    @patch("pajgps_api.pajgps_requests.PajGpsRequests._execute_request")
    def test_get_custom_notifications_success(self, mock_execute):
        mock_response = unittest.mock.Mock()
        mock_response.json.return_value = {
            "success": [
                {
        ...
        notifications = self.api.get_custom_notifications(102, 1234567000, 1234567890)
    ...
    @patch("pajgps_api.pajgps_requests.PajGpsRequests._execute_request")
    def test_mark_notifications_read_by_device_success(self, mock_execute):
        mock_response = unittest.mock.Mock()
        mock_response.json.return_value = {"success": 5}
        mock_execute.return_value = mock_response

        result = self.api.mark_notifications_read_by_device(103, 1)
    ...
    @patch("pajgps_api.pajgps_requests.PajGpsRequests._execute_request")
    def test_mark_notifications_read_by_customer_success(self, mock_execute):
        mock_response = unittest.mock.Mock()
        mock_response.json.return_value = {"success": "Notifications updated"}
        mock_execute.return_value = mock_response

        result = self.api.mark_notifications_read_by_customer(1)
